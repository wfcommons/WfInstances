...
[Streamflow](https://streamflow.di.unito.it/) executions. The instances
hosted in this directory use
[WfFormat](https://github.com/wfcommons/wfformat) for describing workflow
executions.
...
- [1000Genome](https://github.com/alpha-unito/cwl-1000genome-workflow)
